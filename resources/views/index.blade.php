...
@section('content')
    ...
    <body>
        ...
        <section id="hero" class="d-flex align-items-center"
            style="background: url(assets/img/bg/dekstop2.png);background-size: cover; margin-top: -25px">
                        ...
                        <div class="count-boxes">
                            <div class="count-box">
                                <div class="left-content">
                                    <span style="font-family: Manrope;"><b>2979</b></span><span class="plus"
                                        style="font-size: 25px;margin-top: 23.5px;position:absolute;margin-left:1px; font-family: Manrope; ">+</span>
                                </div>
                                <div class="right-content" style="margin-left:0px">
                                    {{-- <p style="margin-left:0px">Peers to network and learn with</p> --}}
                                    <p style="margin-left: 0px; color: #000; font-family: Manrope;"><b
                                            style="font-family: Manrope;">Sobat Insans yang Mendaftar</b></p>
                            ...
                            <div class="count-box">
                                <div class="left-content">
                                    <span style="font-family: Manrope;"><b>101</b></span><span
                                        style="font-family: Manrope; font-size: 25px;margin-top: 23.5px;position:absolute;margin-left:1px ">+</span>
                                </div>
            ...
            <div class="container" data-aos="fade-up" style="">
                ...
                <div class="row justify-content-center">
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="100"
                        style="background: url(assets/img/bg/bg4.png);background-size: cover;">
                        <div class="labels" style="margin-left:-20px">
                            <span class="icon">
                                <img src="assets/img/bg/ico4.png" alt="Deskripsi Gambar"
                                    style="margin-top:-5px; width:30px;position:absolute;margin-left:-10px">
                            </span>
                        ...
                        <h4 class="title">
                            <p
                                style="color: #1E1E1E;font-family: Manrope;font-size: 12px;font-style: normal;font-weight: 700;line-height: normal;">
                                Class Program</p>
                            <p href=""
                                style="color: #1E1E1E;
                                      font-family: Manrope;
                        ...
                        <img src="assets/img/bg/gmb4.png" alt="Deskripsi Gambar" width="180px;"
                            style=" margin-top: -130px;">
                    </div>

                    <div class="icon-box" data-aos="fade-up" data-aos-delay="200"
                        style="background: url(assets/img/bg/bg3.png);background-size: cover;">
                        <div class="label"
                            style="line-height:22px; margin-top:10px; text-align:left; padding-left:11px; padding-right:11px;">
                            <span class="icon">
                        ...
                        <img src="assets/img/bg/gmb2.png" alt="Deskripsi Gambar" width="200px;"
                            style=" margin-top: -10px;">
                    </div>

                    <div class="icon-box" data-aos="fade-up" data-aos-delay="300"
                        style="background: url(assets/img/bg/bg2.png);background-size: cover;">
                        <div class="label" style="line-height:19px; margin-top:10px">
                            <span class="icon">
                                <img src="assets/img/bg/ico3.png" alt="Deskripsi Gambar"
                                    style="margin-top:-3px;width:15px;margin-right:5px;  display:inline;">
                            </span>
                            <span class="label-text"
                        ...
                        <img src="assets/img/bg/card3.png" alt="Deskripsi Gambar" width="145px"
                            style="margin-top: -45px; ">
                    </div>

                    <div class="icon-box" data-aos="fade-up" data-aos-delay="400"
                        style="background: url(assets/img/bg/bg1.png);background-size: cover;">
                        <div class="label" style="line-height:19px; margin-top:10px">
                            <span class="icon">
                                <img src="assets/img/bg/ico1.png" alt="Deskripsi Gambar"
                                    style="margin-top:-0px;width: 19px;margin-right:5px;  display:inline;">
                            </span>
                            <span class="label-text"
                                style="font-family:'Manrope'; white-space: normal;word-wrap: break-word;
                        ...
                        <img src="assets/img/bg/gmb1.png" alt="Deskripsi Gambar" width="100px"
                            style="margin-top: -10px; ">
                    ...
                    <div class="icon-box" data-aos="fade-up" data-aos-delay="500"
                        style="background: url(assets/img/bg/bg5.png);background-size: cover;">
                        <div class="label" style="line-height:19px; margin-top:10px">
                            <span class="icon">
                                <img src="assets/img/bg/akhir.png" alt="Deskripsi Gambar"
                                    style="margin-top:-0px;width:17px;margin-right:5px; display:inline;">
                            </span>
                            <span class="label-text"
                                style="font-family:'Manrope'; white-space: normal;word-wrap: break-word;
                        ...
                        <img src="assets/img/bg/gmbf.png" alt="Deskripsi Gambar" width="190px"
        ...
        <section id="popup" class="popup" style="padding:30px 0 80px 0;">
            <div class="button-container mb-4" style="margin-top:0px;">
                <span style="float: left; margin-left: 6%;"><img src="assets/img/logo/bintang.png" alt="bintang"
                        style="width: 30px;margin-top:0px;margin-right:5px"></span>
                <h1 class="custom-text"
                    style=" font-family: Arial, sans-serif; font-size: 18px; font-weight: bold; margin-left: 5px; margin-right:10px;">
                    Paket
                    populer untuk </h1>
                <button type="button" class="custom-button" data-toggle="modal" data-target="#tulis"
                    aria-hidden="true" style="font-family: Arial, sans-serif; margin-top: 12px;">Mahasiswa <i
                        class="fa-solid fa-chevron-down"></i></button>
            </div>
            <div class="modal fade" id="tulis" tabindex="-1" role="dialog" aria-labelledby="tulisTitle"
                aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="btn-group" style="">
                                ...
                                <button type="button" class="btn btn-list"
                                    style="background: #6770E9; border-radius: 25px;"><span class="icon">
                                        <img src="assets/img/bg/edit.png" alt="Deskripsi Gambar"
                                            style="width:75px;position:center;  margin-top: 11px;">
                                    </span>
                                ...
                                <button type="button" class="btn btn-list"
                                    style="background: #41BAAC; border-radius: 25px;"><span class="icon">
                                        <img src="assets/img/bg/notes.png" alt="Deskripsi Gambar"
                                            style="width:75px;position:center; margin-top: 15px;"></span>
                                    <div style="margin-top: 10px;">Penyusunan
                                        <br> bab 4-bab 5
                                    </div>
                                </button>
                                <button type="button" class="btn btn-list"
                                    style="background: #F7965A; border-radius: 25px;"><span class="icon">
                                        <img src="assets/img/bg/group.png" alt="Deskripsi Gambar"
                                            style="width: 75px;position:center; margin-top: 18px;">
                                    </span>
        ...
        <section id="paketmentor" class="paketmentor mb-5"
            style="background-color: #f0f0f0; margin-top:-80px; margin-bottom: 0px; ">
            <div class="paketmentorbg mb-5">
                ...
                <div class="row row-cols-1 row-cols-md-4 g-4 ml-2 mr-2 mt-5 "
                    style="margin: -50px;    margin-top: -10px!important;">
                    <div class="col">
                        <div class="card h-100"
                            style="border-radius: 25px; border: 5px solid #1b5cc5;box-shadow: 6.436px 9.01px 23.17px 0px rgba(0, 0, 0, 0.14), 24.457px 36.042px 42.478px 0px rgba(0, 0, 0, 0.12), 54.062px 79.807px 57.924px 0px rgba(0, 0, 0, 0.07), 95.253px 142.879px 68.222px 0px rgba(0, 0, 0, 0.02), 149.315px 222.686px 74.658px 0px rgba(0, 0, 0, 0.00);">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <table>
                                        <thead>
                                ...
                                <ul class="deskripsi" style="list-style: none;">
                                    ...
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;margin-left: -22px;"></i>
                                        Topik penelitian. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Variabel
                                        penelitian. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px; "></i> Objek
                                        penelitian. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Judul
                                        penelitian. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Rumusan
                                        masalah penelitian.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Dasar teori
                        ...
                        <div class="card h-100"
                            ...
                            <div class="card-body">
                                ...
                                <ul class="deskripsi" style="list-style: none;">
                                    ...
                                    <strong> Materi: </strong>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Latar
                                        belakang.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Identifikasi
                                        masalah. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px; "></i> Rumusan
                                        masalah. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Tujuan dan
                                        manfaat penelitian. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Teori dasar.
                                    </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Kerangka
                                        konseptual.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Tinjauan
                                        literatur.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Riset-riset
                                        terkait.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Kerangka
                                        konsep.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Hipotesis
                                        penelitian.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Metode
                                        penelitian.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Populasi dan
                                        sampel.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i>
                                        Variabel-variabel penelitian.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Teknik
                                        pengumpulan data.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Teknik
                                        analisis data.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                        ...
                                        validasi data.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Prosedur
                                        penelitian.</li>
                                </ul>
                                </p>
                            </div>
                        ...
                        <div class="card h-100"
                            ...
                            <div class="card-body">
                                ...
                                <ul class="deskripsi" style="list-style: none;">
                                    ...
                                    <strong> Materi: </strong>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Input data.
                                    </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Olah data.
                                    </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px; "></i> Tabulasi
                                        data. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Interpretasi
                                        data. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Hasil dan
                                        pembahasan.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Menyusun
                                        transkrip wawancara.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Menyusun hasil
                                        wawancara.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Kesimpulan,
                        ...
                        <div class="card h-100" style="border-radius: 25px; border: 5px solid #1b5cc5;">
                            <div class="card-body">
                                ...
                                <ul class="deskripsi" style="list-style: none;">
                                    ...
                                    <strong> Materi: </strong>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Review
                                        proposal skripsi <br> bab 1-3.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Review skripsi
                                        full bab 1-5. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px; "></i> Review
                                        artikel jurnal. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Teknis
                                        penulisan skripsi atau artikel jurnal yang masih keliru. </li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Teknis
                                        penulisan skripsi atau artikel jurnal yang masih keliru.</li>
                                    <li style="align-items:flex-start;"><i class="fa-solid fa-circle-check"
                                            style="color: #1b5cc5; margin-top:5px; margin-left: -22px;"></i> Saran dan
        ...
        <section id="youtube" class="youtube" style="margin-top: -155px;">
            <div class="section-title judul">
                <h3 style="margin-top:-10px;">Coba GRATIS <br> Kelas Tugas Kuliah (KTK) sekarang juga! <span
                        style=""><img src="assets/img/logo/bintang.png" alt="bintang"
                            style="width: 30px;margin-top:-10px;margin-right:5px"></span></h3>
            </div>
                        ...
                        <div class="video-container" style="margin-top: -15px;">
                            <div class="video-container2">
                                <div class="video-wrapper">
                                    <iframe width="2000" height="315"
                                        style="margin-top:2px; width: 94%; margin-right: -10px; border-radius: 25px;"
                    ...
                    <div class="row blok">
                        <div class="col-lg-6 pt-4 pt-lg-0 contentbolo d-flex flex-column" data-aos="fade-up"
                            ...
                            <div class="content-selector"
                                style="border-radius: 50px; border: 2.5px solid #000; width: 220px; height: 60px;">
                                <button id="content1Btn" class="btn btn-primary active"
                                    style="margin-top: 5px; margin-left:-2px;"><b>Skripsi</b></button>
                                <button id="content2Btn" style="margin-top: 5px; margin-right:-2px;"
                                    class="btn btn-primary"><b>KTI</b></button>
                            </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="button" class="btn btn-primary btn-get-started scrolltolo"
                        ...
                        <div class="gambareo col-lg-6 d-flex align-items-center" data-aos="fade-right"
                            data-aos-delay="100" style="margin-top: 10px;">
                            <br> <br>
                            <img src="assets/img/bg/friskaindex.png" class="img-fluid" alt=""
                ...
                <div class="content" id="content2">
                    <div class="row blok">
                        <div class="col-lg-6 pt-4 pt-lg-0 contentbolo d-flex flex-column" data-aos="fade-up"
                            ...
                            <div class="content-selector"
                                style="border-radius: 50px; border: 2.5px solid #000; width: 220px; height: 60px;">
                                <button id="content3Btn" class="btn btn-primary active"
                                    style="margin-top: 5px; margin-left:-2px;"><b>Skripsi</b></button>
                                <button id="content4Btn" class="btn btn-primary"
                                    style="margin-top: 5px; margin-right:-2px;"><b>KTI</b></button>
                            </div>
                            <p style="font-size: 18px; text-align: left; margin-top:10px;">
                        ...
                        <div class="gambareo col-lg-6 d-flex align-items-center" data-aos="fade-right"
                            data-aos-delay="100" style="margin-top: 10px;">
                            <br> <br>
                            <img src="assets/img/bg/friskaindex2.png" class="img-fluid" alt=""
                                style="width: 100%; ">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="left_coloum floatleft">
                        ...
                        <span class="left-scroll-button" onclick="customScrollLeft()">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35"
                                style="margin-left: 5px; margin-top: 80px;" viewBox="0 0 35" fill="none">
                        ...
                        <span class="right-scroll-button" onclick="scrollRight()">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35px"
                                style="margin-right: -30px; margin-top: 80px;" viewBox="0 0 35" style="float: right;"
                                fill="none">
                                <g filter="url(#filter0_b_229_15)">
                                    <path opacity="0.4"
                                        d="M17.4812 48.5835H35.5189C43.3342 48.5835 48.5834 43.5573 48.5834 36.0733V16.927C48.5834 9.443 43.3342 4.41683 35.5189 4.41683H17.4812C9.66817 4.41683 4.41675 9.44521 4.41675 16.9292L4.41675 36.0733C4.41675 43.5573 9.66817 48.5835 17.4812 48.5835Z"
                        ...
                        <span class="left-scroll-button1" onclick="scrollLeft1()" style="margin-top: 50px;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" style="margin-left: 5px;"
                                viewBox="0 0 40" fill="none">
                                <g filter="url(#filter0_b_229_15)">
                                    <path opacity="0.4"
                                        d="M17.4812 48.5835H35.5189C43.3342 48.5835 48.5834 43.5573 48.5834 36.0733V16.927C48.5834 9.443 43.3342 4.41683 35.5189 4.41683H17.4812C9.66817 4.41683 4.41675 9.44521 4.41675 16.9292L4.41675 36.0733C4.41675 43.5573 9.66817 48.5835 17.4812 48.5835Z"
                                        fill="black" />
                        ...
                        <span class="right-scroll-button1" onclick="scrollRight1()" style="margin-top: 50px;">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" style="margin-right: -42px;"
                                viewBox="0 0 40" fill="none">
                                <g filter="url(#filter0_b_229_15)">
                                    <path opacity="0.4"
                                        d="M17.4812 48.5835H35.5189C43.3342 48.5835 48.5834 43.5573 48.5834 36.0733V16.927C48.5834 9.443 43.3342 4.41683 35.5189 4.41683H17.4812C9.66817 4.41683 4.41675 9.44521 4.41675 16.9292L4.41675 36.0733C4.41675 43.5573 9.66817 48.5835 17.4812 48.5835Z"
                                        ...
                                        <div class="left_content">
                                            <h3>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="23"
                                                    ...
                                                    style="float: left; margin-right: 5px; width: 12px; height: 16px;">
                                                    <path
                                                ...
                                                <a href="{{ asset($item->tampilan) }}"
                                                    style="text-decoration: none; color: inherit; font-size:14px !important;">
                                                    {{ $item->sumber }}
                                                </a>
                                            </h3>
                                            ...
                                            <p style="    margin-top: -5px;">
                                                <strong
                                                    style="color: #f3b6b6; font-family: Manrope; font-style: normal; font-weight: 700; line-height: normal;">
                                                    <a href="{{ asset($item->tampilan) }}"
                                                        style="text-decoration: none; color: black; font-size:12px !important; ">Video
                                                        :
                                                        {{ $item->judul }}
                                                    </a>
                                                </strong>
                                            ...
                                            <p class="single_cat_right_content_meta"
                                                style="color: #696969; font-family: Manrope; font-style: normal; line-height: normal; font-size:8px !important;">
                                                {{ $item->waktu }}
                                            </p>
                                        </div>
        ...
        <section id="testimonials" class="testimonials"
            style="margin-top: -100px;  margin-bottom:px;  background: url(assets/img/bg/bgmentor.png);background-size: cover;">
        ...
        <section id="galeri" class="galeri" style="margin-top: -80px; margin-bottom:-50px;">
            ...
            <div class="galeri-container">
                <div class="image-container">
                    ...
                    <img src="assets/img/clients/client-1.png" alt="Gambar 1" id="gambar"
                        ...
                        <div class="row" id="team-members">
                            ...
                            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                                <div class="konsultasi-content">
                                    <div class="member-img">
                                        ...
                                        <img src="assets/img/bg/cuate.png" class="img-fluid"
                                            style="margin-top: -10px; width: 180px;" alt="">
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                                <div class="konsultasi-content">
                                    <div class="member-img">
                                        <!-- Ganti sumber gambar dengan gambar PNG yang memiliki latar belakang transparan -->
                                        <img src="assets/img/bg/bro.png" class="img-fluid" style="width: 165px;"
                                            alt="">
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                                <div class="konsultasi-content">
                                    <div class="member-img">
                                        <!-- Ganti sumber gambar dengan gambar PNG yang memiliki latar belakang transparan -->
                                        <img src="assets/img/bg/cuatei.png" class="img-fluid" style="width: 255px;"
                                            alt="">
                                    </div>
                                    <div class="member-info">
                            ...
                            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                                <div class="konsultasi-content">
                                    <div class="member-img">
                                        <!-- Ganti sumber gambar dengan gambar PNG yang memiliki latar belakang transparan -->
                                        <img src="assets/img/bg/rafiki.png" class="img-fluid" style="width: 240px;"
                                            alt="">
                                    </div>
                                    <div class="member-info">
