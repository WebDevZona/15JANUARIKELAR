...
@section('content')
    ...
    <body>
        ...
        <!-- ======= Hero Section ======= -->
        <section id="hero"
            class="d-flex align-items-center"style="background: url(assets/img/bg/dekstop2.png);background-size: cover; margin-top: -18px">
                        ...
                        <div class="count-boxes">
                            <div class="count-box">
                                <div class="left-content">
                                    <span style="font-family: Manrope;"><b>2979</b></span><span
            ...
            <div class="container" data-aos="fade-up"style="">
                ...
                <div class="row justify-content-center">
                    <div class="icon-box" data-aos="fade-up"
                        data-aos-delay="100"style="background: url(assets/img/bg/bg4.png);background-size: cover;">
                    ...
                    <div class="icon-box" data-aos="fade-up"
                        data-aos-delay="200"style="background: url(assets/img/bg/bg3.png);background-size: cover;">
                        <div
                    ...
                    <div class="icon-box" data-aos="fade-up"
                        data-aos-delay="400"style="background: url(assets/img/bg/bg1.png);background-size: cover;">
                        <div class="label"style="line-height:19px; margin-top:10px">
                            <span class="icon">
                    ...
                    <div class="icon-box" data-aos="fade-up"
                        data-aos-delay="500"style="background: url(assets/img/bg/bg5.png);background-size: cover;">
                        <div class="label"style="line-height:19px; margin-top:10px">
                            <span class="icon">
        ...
        <section id="popup" class="popup" style="padding:30px 0 80px 0;">
            <div class="button-container mb-4" style="margin-top:0px;">
                <span style="float: left; margin-left: 6%;"><img src="assets/img/logo/bintang.png" alt="bintang"
                        style="width: 30px;margin-top:11px;margin-right:5px"></span>
                <h1 class="custom-text"
                    style=" font-family: Arial, sans-serif; font-size: 18px; font-weight: bold; margin-left: 5px; margin-right:10px;">Paket
                    populer untuk </h1>
                <button type="button" class="custom-button" data-toggle="modal" data-target="#tulis"
                    aria-hidden="true" style="font-family: Arial, sans-serif; margin-top: 2px;">Mahasiswa <i
        ...
        <section id="paketmentor" class="paketmentor mb-5" style="background-color: #f0f0f0; margin-bottom: 0px; ">
            <div class="paketmentorbg mb-5">
                <h2 class="judul-tengah mt-5"style="font-family: Manrope;">Konsultasi Reguler Bersama Mentor
                </h2>
        ...
        <!-- HTML -->
        <section id="youtube"
            class="youtube"style="margin-top: 50px background: url(assets/img/bg/halo.png);background-size: cover;">
            <div class="section-title judul">
                <h3>Coba GRATIS <br> Kelas Tugas Kuliah (KTK) sekarang juga! <span style=""><img
                            src="assets/img/logo/bintang.png" alt="bintang"
                    ...
                    <div class="row blok">
                        <div class="col-lg-6 pt-lg-0 contentbolo d-flex flex-column" data-aos="fade-up"
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="button"
                                    class="btn btn-primary btn-get-started scrolltolo"style="margin-top:15px;margin-bottom:15px">Lihat
                                    Selengkapnya</button>
                            </div>
                        </div>

                        <div class="gambareo col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100"
                        style="margin-top: 10px;">
                            <br> <br>
                            <img src="assets/img/bg/wshop1.png" class="img-fluid" alt=""
...
<section id="testibaru" class="testibaru section-bg " style="margin-top: -200px;">
    <div class="pyoutube">
        <br>
            <div class="youtubeeeeeee">
                <div class="gabung">
                    ...
                    <div class="info">
                        ...
                        <button class="btnyt" style="border-radius: 50%; width: 89px; height: 89px;">
        ...
        <section id="galeri" class="galeri" style="margin-top: -50px;">
            <div class="section-title "style=" font-family: 'Roboto', sans-serif;
                ...
                <!-- <h2>About</h2> -->
                <div class="left-align"style=" text-align: left; margin-left:150px margin-bottom:300px">
                    <h3 style="font-family: 'Manrope', sans-serif; margin-left:100px">Janji Mentor <br> Untuk Sobat
                        Insans...</h3>
                            ...
                            <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                                <div class="konsultasi-content">
                                    <div class="member-img">
                                        ...
                                        <img src="assets/img/bg/cuate.png" class="img-fluid" style="width: 180px;"
                                            alt="">
                                    </div>
