...
@section('content')
<section class="content card" style="padding: 10px 10px 20px 20px; margin-top:30px;">
    <div class="box">
        @if(session('sukses'))
        ...
        <div class="row">
            <div class="col">
                <h4><i class="nav-icon fas fa-child my-0 btn-sm-1"></i> Paket Konsultasi Reguler</h3>
                    <hr>
            </div>
        </div>
        ...
        <section>
            <div class="row row-cols-1 row-cols-md-4 g-4 ml-2 mr-2" style="margin-top: -80px;">
                <div class="col">
