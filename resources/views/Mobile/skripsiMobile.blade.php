...
<body>
    ...
    <section id="about" class="heada" style="background: url(assets/img/bg/utama.png);background-size: cover; ">
        <div class="container" data-aos="fade-up">
            <div class="section-title">
                ...
                <p style="font-size: 12px !important; margin-top: -2px;font-family:Manrope !important; font-weight:300;">Home > Pelatihan Skripsi</p>
            </div>
        </div>
    </section>
    ...
    <section id="hero-skripsi" class="d-flex align-items-center" style="height:50vh!important;">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            ...
            <h2 style="font-family: Montserrat; margin-left:120px !important;">Kelas Pelatihan Skripsi Class Program bertujuan untuk membantu Sobat Insans dalam memahami sistematika dan penyusunan skripsi yang akan dibimbing langsung oleh Mentor</h2>
        </div>
    </section>
    <!-- ======= End Section Hero ======= -->
        ...
        <div class="container" data-aos="fade-up">
          ...
          letter-spacing: 1px;">CLASS PROGRAM</a>
            ...
            <div class="section-title">
                ...
                <h4 style="margin-bottom: 35px !important; margin-top:10px; font-size: 15px !important;">Kelas Pelatihan Skripsi Class Program </h4>
            </div>

            <div class="card-containerr">
                <div class="row ">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="custom-box" style="height: 450px; border-radius: 20px;  border: 2px solid #020202;">
    ...
    <section id="mentor-skripsi" class="mentor-skripsi" style="margin-top:-50px;">
        <div class="container">
            <div class="section-title">
                <h3 style="color:rgb(0,29,73); font-size: 25px !important;  margin-top:0px  !important;">Mentor Yang Berpengalaman</h3>
                <h4 style="color:rgb(0,29,73); margin-top:10px !important; font-size: 15px !important; ">Kelas Pelatihan Skripsi Class Program </h4>
            </div>
 ...
 -->
    <section id="faq" class="faq section-bg" style="background-size: cover; background-color: #bbcde9; position: relative; margin-top:-200px;">
        ...
        <div class="container kontener aos-init aos-animate" style="text-align:center;" data-aos="fade-up">
            ...
            ">
                    <h3 style="color:rgb(0,29,73); margin-bottom:50px; font-size:25px !important;">Frequently Asked Questions</h3>
                </div>
                <style>
                    .accordion-item {
                        border-radius: 8px;
