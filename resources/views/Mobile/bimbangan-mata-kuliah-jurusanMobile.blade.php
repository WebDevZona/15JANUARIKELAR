    ...
    <body>
        ...
        <main id="main">
            ...
            <section id="about" class="heada"
                style="background: url(assets/img/bg/utama2.png);background-size: cover; ">
                <div class="container" data-aos="fade-up">
                    <div class="section-title">
                        <h3 style="color:black; font-size:18px;">Bimbingan Mata Kuliah Jurusan (BMJ)</h3>
                        <p
                            style="color:black; font-size: 12px !important; margin-top: -2px;font-family:Manrope !important; font-weight:300;">
                            Home > Bimbingan Mata Kuliah Jurusan (BMJ)</p>
                    </div>
                </div>
            </section>

            <section id="hero" class="d-flex align-items-center"
                style="background: url(assets/img/bg/bmj.png); background-size: cover; position: relative; height: 50vh !important;">

                {{-- <img style="height: 580px; margin-top: -30px; position: absolute; left:0px;  top: 0;" src="assets/img/bg/bmjriska.png" alt="" /> --}}

                <div class="container" data-aos="zoom-out" data-aos-delay="100"
                    style=" margin-bottom: 130px; margin-top:100px;">
                    <div style="width: 100%; display: flex; justify-content: center; ">
                        <div
                            style="margin-left: 15px; width: 180px; height: 100%; padding: 6.40px; background: #3E87F8; box-shadow: 6.400178909301758px 6.400178909301758px 12.800357818603516px rgba(0, 0, 0, 0.15); border-radius: 32px; justify-content: center; align-items: center; gap: 6.40px; display: inline-flex; margin: 0 auto;">
                            <div
                                style="color: white; font-size: 12px; font-family: Montserrat; font-weight: 700; line-height: 25.60px; word-wrap: break-word">
                                CLASS PROGRAM</div>
                        </div>
                    </div>

                    <div
                        style="width: 100%; text-align: center; color: #09326F; font-size: 25px; font-family: Montserrat; font-weight: 800;  word-wrap: break-word; margin-top: 20px; ">
                    ...
                    <p
                        style=" margin-top: 2px; text-align: center; color: #202020; font-size: 12px; font-family: Montserrat; font-weight: 500;  ">
                        Bimbingan Mata kuliah Jurusan (BMJ) Class Program disediakan secara khusus untuk membantu mahasiswa
                        dalam memahami materi-materi mata kuliah yang ada di jurusan dengan sistem mentoring/pendampingan
                    </p>

                </div>
                <div id="counts" class="counts"
                    style=" margin-top:260px;z-index: 2 !important; margin-right:100px; width:90%; position: absolute !important; height: auto;margin-left: 20px;">
                    <div class="container">
                        <div class="count-boxes" style="margin-left:-9px;">
                            <div class="count-box">
                                <div class="left-content">
                                    <div style="display: flex; align-items: center; justify-content: center;">
                                        <img style="width:25px; margin-top: 30px;" src="assets/img/bg/bmjschedule.png"
                                            alt="">
                                    </div>
                                </div>
                                <div class="right-content" style="margin-left:0px">
                                    {{-- <p style="margin-left:0px">Peers to network and learn with</p> --}}
                                    <p style="margin-left: 0px; color: #000; font-family: Manrope; font-size:8px;"><b>Waktu
                                            bimbingan<br>24 kali pertemuan</b></p>

                                </div>
                            </div>

                            <div class="count-separator" style="margin-top: 15px; "></div> <!-- Garis vertikal -->
                            <div class="count-box" style="margin-left:-55px;">
                                <div class="left-content">
                                    <div style="display: flex; align-items: center; justify-content: center;">
                                        <img style="width:40px; margin-top: 30px;" src="assets/img/bg/durasibimbingan.png"
                                            alt="">
                                    </div>
                                </div>
                                <div class="right-content" style="margin-left:1px">
                                    {{-- <p >Mentor Class Program</p> --}}
                                    <p style="margin-left:0px; color: #000; font-family: Manrope; font-size:8px;"><b>Durasi
                                            bimbingan <br> 2 hingga 4 jam</b></p>
                                </div>
                            </div>

                            <div class="count-separator" style=" margin-top: 15px;"></div>
                            <div class="count-box" style="margin-left: -57px;">
                                <div class="left-content">
                                    <div style="display: flex; align-items: center; justify-content: center;">
                                        <img style="width:40px; margin-top: 30px;" src="assets/img/bg/prosesbimbingan.png"
                                            alt="">
                                    </div>
                                </div>
                                <div class="right-content" style="margin-left:-1px">
                                    <p
                                        style="margin-left:0px;margin-right:10px;  color: #000; font-family: Manrope;font-size:8px;">
                                        <b>Proses<br>bimbingan<br>hingga 2 bulan</b>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <style>
                                ...
                                .card {
                                    ...
                                    /* Efek transisi untuk box-shadow dan border-color */
                                }
                                ...
                                /* Gaya hover untuk card */
                                .card:hover {
                                    box-shadow: 0 0 20px rgba(0, 123, 255, 0.5);
                                    /* Warna shadow biru saat dihover */
                                    border-color: #007bff;
                                    /* Warna border biru saat dihover */
                                }
                            ...
                            <div class="cards-container"
                                style="margin-top:30px; margin-left:50px; display: flex; flex-wrap: nowrap; overflow-x: auto;">
                                <!-- Card 1 -->
                                <div class="card"
                                    style="flex: 0 0 auto; margin-right: 10px; width:200px; height:300px;">
                                    <div style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            ...
                            cardsContainer.addEventListener("scroll", function() {
                                ...
                                activeCardIndex = Math.floor(cardsContainer.scrollLeft / cardWidth);
            ...
            <style>
                #myVideo {
                    ...
                    /* Tambahkan garis tepi 2px dengan warna biru */
                }
                .play-button {
                                    margin-top: 460px;
                                    position: absolute;
            ...
            <video width="250" height="450" controls
                style="margin-top: 10px; margin-bottom: 30px; margin-left: 55px; border-radius: 2%; box-shadow: 0px 0px 15px rgba(0, 0, 255, 0.2); "
                id="myVideo">
                <source src="assets/video/1.mp4" type="video/mp4">
            </video>
            <section id="about" style="margin-top: -800px; margin-bottom: 250px;">
                <div class="container" data-aos="fade-up">
                    <div style="width: 100%; height: 100%; margin-bottom:800px; opacity: 0.85">
                        <img style="width: 100%; height: 100%; position: absolute; mix-blend-mode: multiply; top: 0; left: 0; border-radius:15%;"
                    ...
                    <div class="row align-items-center justify-content-between"
                        ...
                        <div class="pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up"
                            ...
                            <div class="section-title">
                                <span class="a">
                                    <h3 style="font-size: 20px; color: #ffff; font-family: Montserrat;">
                                        Nanti di BMJ bakal <br> ngapain aja sih?</h3>
                                </span>
                                <div style="width: 100%;  height: 100%; position: relative">
                                    <div
                                        style="width: px; margin-top:20px; left: 20px; margin-left: 40px; top: 0px; color: white; font-size: 12px; font-family: Montserrat; font-weight: 600; text-align: left;">
                                ...
                                <div style="width: 100%;  height: 100%; position: relative">
                                    <div
                                        style="width: px; margin-top:20px; margin-bottom:20px; left: 20px; margin-left: 40px; top: 0px; color: white; font-size: 12px;font-family: Montserrat; font-weight: 600;  text-align: left;">
                                        Sobat Insans bisa konsultasi terkait konsentrasi jurusan dan Praktek Kerja
                                        Lapangan.
                                    </div>
            ...
            <img style="margin-top: -300px; margin-bottom:150px; width: 100% !important;" src="assets/img/bg/bmjkukuh.png"
            alt="">
                ...
                <div class="container" data-aos="zoom-out" data-aos-delay="100">
                    <div class="juduldua">
                        <h3>
                            ...
                            <br>
                            <span
                                style="color: #3E87F8; font-family: Montserrat; font-weight: 700;letter-spacing:2px;
                            line-height: 125%; font-size:40px;">2564+</span>
                            <br>
                            ...
                            <div
                                ...
                                <div
                                    style="margin-top:10px; width: 170px; height: 100%; padding: 3px; background: #3E87F8; box-shadow: 6.400178909301758px 6.400178909301758px 12.800357818603516px rgba(0, 0, 0, 0.15); border-radius: 32px; justify-content: center; align-items: center; gap: 6.40px; display: inline-flex;margin-left: -80px;">
                                    <div
                                        style="color: white; font-size: 20.48px; font-family: Montserrat; font-weight: 700; line-height: 25.60px; word-wrap: break-word">
                                        <a href="/login" style="color: #fff; letter-spacing: 0.1px; font-size:12px;">Pesan Sekarang</a>
                                    </div>
                                </div>
                            </div>
                            <br>

                            <div class="row" style="margin-bottom:120px;margin-left: 10px;">
                                <div class="col">
                                    <div style="width: 100%; height: 100%; position: relative">
                                        <div
                                            style="width: 120px; height: 90px; padding: 27.25px; left: 0px; top: 29.40px; position: absolute; background: white; box-shadow: 0px 8.51637077331543px 42.58185577392578px rgba(0, 0, 0, 0.15); border-radius: 21.29px; border: 0.85px rgba(25, 24, 37, 0.10) solid; flex-direction: column; justify-content: flex-start; align-items: center; gap: 13.63px; display: inline-flex">
                                            <div
                                                style="letter-spacing: 0.1px; color: #3E87F8; font-size: 20px; font-family: Montserrat; font-weight: 700; line-height: 35.77px; word-wrap: break-word">
                                                20+</div>
                                            <div
                                                style="margin-top:-20px; letter-spacing: 0.1px; color: #191825; font-size: 10px; font-family: Montserrat; font-weight: 600; line-height: 24.53px; word-wrap: break-word">
                                                Jurusan</div>
                                        </div>
                                    <div>
                                        <div
                                        style="width: 30px; height: 30px; padding: 16.96px; left: 100px; margin-top:20px;  position: absolute; background: #3E87F8; box-shadow: 0px 0px 0px rgba(0, 0, 0, 0.03); border-radius: 52.99px">
                                    </div>
                                    <img style="width: 15px; height: 15px; left: 104px; position: absolute;top: 30px;"
                                ...
                                <div class="col" style="margin-left: 30px;">
                                    <div style="width: 100%; height: 100%; position: relative">
                                        ...
                                        <img style="width: 15px; height: 15px; left: 104px; top: 30px; position: absolute"
                ...
                <div class="container" data-aos="fade-up">
                    <div class="row align-items-center justify-content-between" style=" margin-top: -80px;">
                        ...
                        <div class="section-title">
                            ...
                            <span class="gariss">
                                <h3
                                    style="color: black; margin-top: 100px; text-align: center; font-size: 20px; padding-bottom: 20px;">
                        ...
                        <div class="container" data-aos="fade-up">
                            <div
                                style=" width: 100%; height: 100%; margin-bottom:800px; position: relative; opacity: 0.85">
                                <img style="width: 100%; height: 400px; position: absolute; mix-blend-mode: multiply; top: 0; left: 0;border-radius: 5%;"
                            ...
                            <div id="cardbmj" class="cardbmj">
                                <div class="row align-items-center justify-content-between"
                                    ...
                                    <div
                                        ...
                                        <ul class="nav nav-pills card-header-pills" id="buttonGroup" style="margin-left: -400px;">
                                            <li class="nav-item" style=" margin-right: 20px; ">
                                                <button class="nav-link color-white border-radius"
                                                    onclick="TampilKonten('kontenbmj1')"><b style="font-size: 8px;">PAKET BRONZE</b></button>
                                            </li>
                                            <li class="nav-item" style="margin-right: 20px;">
                                                <button class="nav-link color-white2 border-radius"
                                                    onclick="TampilKonten('kontenbmj2')" data-target="all"><b style="font-size: 8px;">PAKET
                                                        EMERALD</b></button>
                                            </li>
                                            <li class="nav-item" style="margin-right: 20px;">
                                                <button class="nav-link color-white2 border-radius"
                                                    onclick="TampilKonten('kontenbmj3')" data-target="ktk"><b style="font-size: 8px;">PAKET
                                                        DIAMOND</b></button>
                                            </li>
                                        </ul>
                                    ...
                                    <div id="kontenbmj1" class="kontenbmj aktif">
                                        {{-- <img style="margin-bottom:50px; margin-top:-63px;  float: left; width: 418px;   margin-left: -120px;   height: auto;"
                                            src="assets/img/bg/bronze.png" alt=""> --}}
                                        <div
                                            style="font-family: Montserrat; text-align: left;  color: white; font-size: 12px; font-weight: 400; line-height: 1.5; letter-spacing: -1px; margin-left:15px;">
                                            Program bimbingan yang dikhususkan untuk mahasiswa <br>semester 1-2 dengan mata
                                            kuliah umum sampai khusus <br> sesuai jurusan dan konsultasi konsentrasi
                                            jurusan.
                                        </div>

                                        <div class="buttoncircle" style="display: flex; align-items: center;">
                                            <i class="bi bi-check2-circle"
                                                style=" margin-left: 120px; color: #fff; margin-top: -15px; margin-right: 10px; font-size:20px;"></i>
                                            <div
                                                style="font-family: Montserrat; text-align: left; margin-left: 5px; margin-top: 20px; color: white; font-size: 12px; font-weight: 400; line-height: 1.5; letter-spacing: -1px;">
                                    ...
                                    <div id="kontenbmj2" class="kontenbmj ">
                                        {{-- <img style="margin-bottom: 250px;  float: left; width: 418px;   margin-left: 120px;   height: auto;"
                                    ...
                                    <div id="kontenbmj3" class="kontenbmj ">
                                        {{-- <img style="margin-bottom: 50px; margin-top: -1px; float: left; width: 418px;     margin-left: 72px;   height: auto;"
            ...
            <section id="pricing" class="pricing"
                style="background-color:#09326f; margin-top:px; margin-bottom: 100px;">

                <div class="container" data-aos="fade-up">
                    <div style="width: 100%; text-align: center;">
                        <div
                            style="width: 100px; height: 40px; padding: 5px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; justify-content: center; align-items: center; gap: 10px; display: inline-flex; margin: 0 auto;">
                            <div
                                style="width: 424px; text-align: center; color: white; font-size: 20px; font-family: Montserrat; font-weight: 700; line-height: 40px; word-wrap: break-word">
                                PAKET</div>
                        </div>
                    </div>
                    {{-- Bmj --}}
                                ...
                                <div class="custom-carousel">
                                    ...
                                    ">
                                        ...
                                        <ul>
                                            ...
                                            <li class="left-aligned">
                                                <span class="checkmark">&#10003;</span>
                                                <span class="text-bso"> Waktu bimbingan 12 kali<br>pertemuan</span>
                                            </li>
                                            <li class="left-aligned">
                                                <span class="checkmark">&#10003;</span>
                                                <span class="text-bso"> Jadwal bimbingan 1 minggu,<br> 3x pertemuan</span>
                                            </li>
                                            <li class="left-aligned">
                                                <span class="checkmark">&#10003;</span>
                                    ...
                                    ">
                                        ...
                                        <ul>
                                            ...
                                            <li class="left-aligned">
                                                <span class="checkmark">&#10003;</span>
                                                <span class="text-bso">6 Mata Kuliah (umum dan<br> khusus)</span>
                                            </li>
                                            <li class="left-aligned">
                                                <span class="checkmark">&#10003;</span>
                                                <span class="text-bso">Konsultasi konsentrasi jurusan</span>
                ...
                <div class="container" data-aos="fade-up">
                    <div class="row align-items-center justify-content-between"
                        ...
                        <div class="col-lg-6 text-centerr">
                            <div style="width: 100%; height: 100%; position: relative">
                                <div style="width: 50px; margin-left: 150px; left: 0px; top: px; position: absolute;    margin-top: 22px;
                                " >
                                    <div
                                        style="width: 30px; height: 30px; left: 0px; top: 0px;  background: #09326F; border-radius: 9999px">
                                    </div>
                                    <div
                                        style="width: 25px; height: 25px; left: 7.66px; top: 0px; margin-top:-75px;  text-align: center; color: white; font-size: 40px; font-family: Montserrat; font-weight: 700; line-height: 131.38px; word-wrap: break-word">
                                        “</div>
                                </div>
                                <div
                                    style="width: 500px; margin-left:70px; margin-top: 50px; top: -110px;  color: black; font-size: 25px; font-family: Montserrat; font-weight: 700; line-height: 80.50px; word-wrap: break-word">
                                    Cerita Sobat Insans</div>
                            </div>
                        </div>
                        <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center"
                            data-aos="fade-up" data-aos-delay="100">
                            {{-- text --}}
                            <img src="assets/img/bg/bmjsobat1.png" class="img-fluid" alt="" style=" width:70% !important;   margin-top: -50px;    margin-left: 140px;">
                        </div>
                    </div>
            </section>
            <!-- End About Section -->
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="centered-content">
                                    <img src="assets/img/team/mentorbmj1.png" class="img-fluid" alt="" style="border: none !important; outline: none !important;">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="centered-content">
                                    <img src="assets/img/team/mentorbmj2.png" class="img-fluid" alt="" style="border: none !important; outline: none !important;">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="centered-content">
                                    <img src="assets/img/team/mentorbmj3.png" class="img-fluid" alt="" style="border: none !important; outline: none !important;">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="centered-content">
                                    <img src="assets/img/team/mentorbmj4.png" class="img-fluid" alt="" style="border: none !important; outline: none !important;">
                                </div>
                            </div>
                        </div>
            ...
            <section id="testimonials" class="testimonials"
                ...
                <div class="section-title" style="margin-top: px; color:#000;">
                    <h3 style=" font-size: 25px;  margin-top:0px  !important;">Alur Bimbingan</h3>
                </div>
                <img src="assets/img/bg/alurbimbingan.png"
                    style="max-width: 70%;  height: auto; display: inline-block; margin-top: 50px;" class=""
                    alt="">
            </section>
                ...
                <div class="container" data-aos="fade-up">
                    <div class="text-center" style="margin-left:-90px;">
                        <div style="width: 100%; height: 100%; position: relative">
                            ...
                            <div
                                style=" width: 500px;  margin-top: 80px;  position: absolute; color: white; font-size: 25px; font-family: Montserrat; font-weight: 700; line-height: 80.50px;">
                                Paling Sering </div>
                            <div
                                style=" width: 500px;  margin-top: 110px;  position: absolute; color: white; font-size: 25px; font-family: Montserrat; font-weight: 700; line-height: 80.50px;">
                                Ditanyakan </div>
                        </div>
                    </div>
                    <div class="row align-items-center justify-content-between"
