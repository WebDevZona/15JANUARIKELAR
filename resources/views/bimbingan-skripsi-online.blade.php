        ...
        <main id="main">
            ...
            <section id="hero" class="d-flex align-items-center"
                ...
                <div class="container" data-aos="zoom-out" data-aos-delay="100">
                    <div class="d-flex">
                        <div
                            style="width: 250px; height: 100%; padding: 10px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; justify-content: center; align-items: center; gap: 10px; display: inline-flex">
                            <div
                ...
                <div class="container" data-aos="fade-up">
                    <div class="row align-items-center justify-content-between"
                        ...
                        <div class="col-lg-6 text-centerr">
                            ...
                            <video width="280" height="500" controls style="margin-left: 120px; margin-top: 160px"
                                id="myVideo">
                    ...
                    <div class="juduldua">
                        <h3>
                            ...
                            <a href="/login" style="text-decoration: none;">
                                <div
                                    style="width: 300px; padding: 10px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; justify-content: center; align-items: center; gap: 10px; display: inline-flex">
                                    <div
                                        style="letter-spacing: 1px; color: white; font-size: 25px; font-family: Montserrat; font-weight: 600; line-height: 37.50px; word-wrap: break-word">
                                        Pesan Sekarang
                                    </div>
                                </div>
                            </a>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div
                                        ...
                                        <div class="card-title">
                                            ...
                                            <div
                                                style="margin-top: -80px; margin-left:90px; color: #101828; font-size: 25px; font-family: Inter; font-weight: 700; letter-spacing: 1px; word-wrap: break-word">
                                                24+</div>
                                            <div
                                                style="margin-top: -50px; margin-left:90px;  opacity: 0.50; color: #101828; font-size: 15px; font-family: Inter; font-weight: 400; letter-spacing: 1px; word-wrap: break-word">
                                                Kampus</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div
                                        style=" margin-left:-80px; width: 180px; margin-top: 40px; height: 100px; background: #F5F5F4; linear-gradient:(180deg, white 0%, #ECF4FF 100%); box-shadow: 0px 18.36px 38.25px rgba(0, 0, 0, 0.15); border-radius: 18.36px; border: 0.76px #09326F solid;">
                                        <div class="card-title" style="margin-top: 10px; margin-left:10px;">
            ...
            <section id="pakethematbso" class="pakethematbso" style="z-index: auto">
                ...
                <div class="card text-center  ml-5 mr-5 " style="border-radius: 25px;">
                    <div class="card-header bg-primary"
                        style="border-radius: 25px;     padding-bottom: 0px;
                ">
                        <style>
                            .color-white2 {
                                color: white;
                        ...
                        <ul class="nav nav-pills card-header-pills" id="buttonGroup">
                            <li class="nav-item" style="border-radius:50%; ">
                                <button style="border-radius: 50px" class="nav-link color-white2"
                                    onclick="showContent('content1')"><b>PAKET SILVER</b></button>
                            </li>
                            <li class="nav-item">
                                <button style="border-radius: 50px" class="nav-link color-white2"
            ...
            <section id="pricing" class="pricing"
                ...
                <div class="container" style="margin-top:200px;" data-aos="fade-up">
                    <div style="width: 100%; text-align: center;">
                        <div
                            style="width: 180px; height: 40px; padding: 10px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; justify-content: center; align-items: center; gap: 10px; display: inline-flex; margin: 0 auto;">
                            <div
                    ...
                    <div>
                        ...
                        <h3 style="color:white; font-size: 50px; text-align:center; margin-top:20px;">Bimbingan Skripsi
                            Online (BSO)</h3>
                        <h4 style="margin-bottom: 80px; text-align: center; color:white;">Memiliki lima jenis paket hemat
                        ...
                        <div class="carousel-inner">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                                            <div class="custom-box" style="height: 640px; border-radius: 15px;">
                                                ...
                                                <div class="rupiah-display" style="position: relative;">
                                                    <h4
                                                        style="position: absolute; top: 0; left: 0; color: #1E1E1E; margin-right: 10px; font-size: 20px;">
                            ...
                            <a class="carousel-control-next" href="#packageCarousel" role="button" data-slide="next">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35px"
                                    style="margin-left: 50px; margin-top: 50px;" viewBox="0 0 35" style="float: right;"
                                    fill="none">
                                    <g filter="url(#filter0_b_229_15)">
                                        <path opacity="0.4"
                                            d="M17.4812 48.5835H35.5189C43.3342 48.5835 48.5834 43.5573 48.5834 36.0733V16.927C48.5834 9.443 43.3342 4.41683 35.5189 4.41683H17.4812C9.66817 4.41683 4.41675 9.44521 4.41675 16.9292L4.41675 36.0733C4.41675 43.5573 9.66817 48.5835 17.4812 48.5835Z"
            ...
            <section id="paketmentor" class="paketmentor" style="background-color: #ffff; margin-top: -50px; ">
                <div class="paketmentorbg mb-5" style="margin-top: 300px;">
                    <div
                        ...
                        <div
                            style="width: 420px; padding: 10px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; display: flex; flex-direction: column; align-items: center; gap: 10px;">
                            <div
                                style="color: white; font-size: 20px; font-family: Montserrat; font-weight: 700; line-height: 40px; word-wrap: break-word;">
                    ...
                    <div style="margin-top: 100px; margin-left: -50px; width: 100%; height: 100%; position: relative">
                        ...
                        <div
                            ...
                            <div
                                style="width: 22.65px; height: 22.65px; left: 89.54px; top: 15.39px; position: absolute; background: #FFC700; border-radius: 9999px">
                            </div>
                            <div
                                style="width: 22.65px; height: 22.65px; left: 128.36px; top: 15.39px; position: absolute; background: #00D930; border-radius: 9999px">
                            </div>
                        </div>
                    </div>
            ...
            <section id="paketmentor" class="paketmentor"
                ...
                <div class="paketmentorbg mb-5" style="margin-top: 300px;">
                    <div style="width: 100%; text-align: center;">
                        <div
                            style="width: 300px; height: 40px; padding: 10px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; justify-content: center; align-items: center; gap: 10px; display: inline-flex; margin: 0 auto;">
                            <div
                                style="width: 424px; text-align: center; color: white; font-size: 20px; font-family: Montserrat; font-weight: 700; line-height: 40px; word-wrap: break-word">
                    ...
                    <h4
                        style=" font-family: Montserrat; text-align: center; font-size: 50px; margin-top: 30px; color:#000; font-weight:bold;">
            ...
            <section id="testibaru" class="testibaru section-bg" style="margin-bottom:15px;">
                                ...
                                <div class="profile-info" style="height: 300px;">
                                    <div style="text-align:center;  margin-top: 50px;">
                                        <i class="fa-solid fa-star"
                                            style="color: #f1d209; font-size: 30px !important;"></i>
                                        <i class="fa-solid fa-star"
                                            style="color: #f1d209; font-size: 30px !important;"></i>
                                        <i class="fa-solid fa-star"
                                            style="color: #f1d209; font-size: 30px !important;"></i>
                ...
                <div class="centered-content">
                    <img src="assets/img/team/a.png" width="50px" height="auto" class="img-fluid"
                        alt="">
                </div>
