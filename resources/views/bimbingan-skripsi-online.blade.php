    ...
    <body>
        ...
        <main id="main">
            ...
            <section id="about" class="heada"
                style="background: url(assets/img/bg/utama.png);background-size: cover; ">
                                    ...
                                    <div
                                        ...
                                        <div class="card-title">
                                            ...
                                            <div
                                                ...
                                                24+</div>
                                            <div
                                                style="margin-top: -50px; margin-left:100px;  opacity: 0.50; color: #101828; font-size: 15px; font-family: Inter; font-weight: 600; letter-spacing: 1px; word-wrap: break-word">
                                                Kampus</div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="card-title" style="margin-top: 10px; margin-left:10px;">
                                            ...
                                            <div
                                                ...
                                                78+</div>
                                            <div
                                                style="margin-top: -50px; margin-left:90px;  opacity: 0.50; color: #101828; font-size: 15px; font-family: Inter; font-weight: 600; letter-spacing: 1px; word-wrap: break-word">
                                                Mentor</div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section id="pakethematbso" class="pakethematbso" style="z-index: auto">
                <img src="assets/img/bg/Ornament_kotak.jpg" alt="gambar sebelah kiri"
                    style="transform: rotate(91deg); margin-top:-50px;">
                <h3
            ...
            <section id="pricing" class="pricing"
                ...
                <div class="container" style="margin-top:200px;" data-aos="fade-up">
                    <div style="width: 100%; text-align: center;">
                        <div
                            style="width: 150px; height: 35px; padding: 10px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; justify-content: center; align-items: center; gap: 10px; display: inline-flex; margin: 0 auto;">
                            <div
                    ...
                    <div>
                        ...
                        <h3 style="color:white; font-size: 30px; text-align:center; margin-top:15px;">Bimbingan Skripsi
                            Online</h3>
                        <h4 style="margin-bottom: 80px; text-align: center; color:white; font-size:15px; font-weight:200;">
            ...
            <section id="paketmentor" class="paketmentor" style="background-color: #ffff; margin-top: -50px; ">
                <div class="paketmentorbg mb-5" style="margin-top: 300px;">
                    <div
                        ...
                        <div
                            style="width: 350px; padding: 2px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; display: flex; flex-direction: column; align-items: center; gap: 10px;">
                            <div
                    ...
                    <p
                        style="margin-top: -280px; width: 100%; text-align: center; color: black; font-size: 35px; font-family: Montserrat; font-weight: 700;line-height: 1.2;">
                    ...
                    <div style="margin-top: 80px; margin-left: -50px; width: 100%; height: 100%; position: relative">
                        ...
                        <div
                            ...
                            <div
                                style="width: 1214px; height: 45px; margin-left: -5px; left: 0px; top: 0px; position: absolute; background: rgba(143, 139, 139, 0.75); border-top-left-radius: 55px; border-top-right-radius: 55px; backdrop-filter: blur(130.68px)">
                            </div>
                            <div
                                style="width: 22.65px; height: 22.65px; left: 50.71px; top: 14px; position: absolute; background: #FF0000; border-radius: 9999px">
                            </div>
                            <div
                                style="width: 22.65px; height: 22.65px; left: 89.54px; top: 14px; position: absolute; background: #FFC700; border-radius: 9999px">
                            </div>
                            <div
                                style="width: 22.65px; height: 22.65px; left: 128.36px; top: 14px; position: absolute; background: #00D930; border-radius: 9999px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card text-center ml-5 mr-5 "
                        style="height: 300px; width: 1214px; border-radius: 0 0 25px 25px;margin-top: -10px;                ">
                        <div class="card-body"
                            style="margin-top:-2px;border-radius: 0 0 0 25px; width: 400px; height: auto; padding-bottom: 0px;padding-top: 0px;background: linear-gradient(270deg, #09326F 54.47%, #3E87F8 119.9%);">
                            ...
                            <div
                                ...
                                <button
                                    style=" border: none; background: transparent;  font-size: 18px !important; font-family: Montserrat; font-weight: 500; line-height: 40px; word-wrap: break-word"
                                    class="nav-bso  active" onclick="showPaket('paket1')"><b>REGULER SILVER</b></button>
                            </div>
                            <!-- Regular botton gold -->
                            <div
                                style="margin-top: 10px; width: 100%;   border-radius: 50px; justify-content: center; align-items: center; gap: 10px; display: inline-flex">
                                <button
                                    style="border: none; background: transparent; border-radius: 50px; font-size: 18px !important; font-family: Montserrat; font-weight: 500; line-height: 40px; word-wrap: break-word;"
                            ...
                            <div id="paket1" class="paketbso card-body active"
                                style="margin-top: -280px; text-align: left; ">
                                <div
                                    style="color: black; font-family: Montserrat; font-size: 20px; width:800px; margin-left: 380px; ">
                                    Dikhususkan kepada Sobat Insans yang sedang membutuhkan bimbingan dalam pembuatan dan
                                ...
                                <div style="margin-left: 400px; display: flex; width:600%; margin-top:10px;">
                                    ...
                                    <div
                                        style="font-family: Montserrat; color: black; font-size: 18px; font-weight: 400; line-height: 1.5; letter-spacing: -1px; width: 700px;">
                            ...
                            {{-- Gold --}}
                            <div id="paket2" class="paketbso card-body "
                                style="margin-top: -280px; text-align: left; ">
                                <div
                                    style="color: black; font-family: Montserrat; font-size: 20px; width:800px; margin-left: 380px; ">
                                    Dikhususkan kepada Sobat Insans yang sedang membutuhkan bimbingan menuju seminar
                            ...
                            {{-- Platinum --}}
                            <div id="paket3" class="paketbso card-body "
                                style="margin-top: -280px; text-align: left; ">
                                <div
                                    style="color: black; font-family: Montserrat; font-size: 20px; width:800px; margin-left: 380px; ">
                            ...
                            {{-- Titanuium --}}
                            <div id="paket4" class="paketbso card-body "
                                style="margin-top: -280px; text-align: left; ">
                                <div
                                    style="color: black; font-family: Montserrat; font-size: 20px; width:800px; margin-left: 380px; ">
                                    Dikhususkan kepada Sobat Insans yang sedang membutuhkan bimbingan Simulasi Seminar
                            ...
                            <div id="paket5" class="paketbso card-body "
            ...
            <section id="paketmentor" class="paketmentor"
                ...
                <div class="paketmentorbg mb-5" style="margin-top: 300px;">
                    <div style="width: 100%; text-align: center;">
                        <div
                            style="width: 300px; height: 40px; padding: 5px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; justify-content: center; align-items: center; gap: 10px; display: inline-flex; margin: 0 auto;">
                            <div
                                style="width: 424px; text-align: center; color: white; font-size: 15px; font-family: Montserrat; font-weight: 700; line-height: 40px; word-wrap: break-word">
                    ...
                    <h4
                        style=" font-family: Montserrat; text-align: center; font-size: 35px; margin-top: 10px; color:#000; font-weight:bold;">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row row-cols-1 row-cols-md-4 g-3 ml-2 mr-2 mt-5 ">
                                    <div class="col">
                                        <div class="card"
                                            style="border-radius: 25px; border: 5px solid #1b5cc5; height: 370px;">
                                            <div class="card-body">
                                                <h5 class="card-title">
                                                    <table>
                                                        <thead>
                                            ...
                                            <div class="card-footer text-center"
                                                ...
                                                <a href="#" class="btn btn-primary"
                                                    style="border-radius: 10px; align-content: center;margin-top: -10px; font-size:12px;">Daftar
                                                    Sekarang</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="profile-slider" style="    display: block; ">
                        ...
                        ">
                                <div class="profile-info" style="height: 250px;">
                                    ...
                                    <p style="margin-top:30px; margin-bottom: 50px; text-align:center; font-size:12px;">
                                        “Alhamdulillah
