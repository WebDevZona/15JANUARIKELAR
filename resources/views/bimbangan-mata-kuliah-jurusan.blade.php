...
<body>
    ...
    <main id="main">
            ...
            <div class="container" data-aos="zoom-out" data-aos-delay="100" style="margin-top: -50px; margin-bottom: 130px;">
                <div style="width: 100%; display: flex; justify-content: center; margin-top: 50px;">
                    <div style="margin-left: 15px; width: 250px; height: 100%; padding: 6.40px; background: #3E87F8; box-shadow: 6.400178909301758px 6.400178909301758px 12.800357818603516px rgba(0, 0, 0, 0.15); border-radius: 32px; justify-content: center; align-items: center; gap: 6.40px; display: inline-flex; margin: 0 auto;">
                        <div style="color: white; font-size: 20.48px; font-family: Montserrat; font-weight: 700; line-height: 25.60px; word-wrap: break-word">
                            CLASS PROGRAM</div>
                    </div>
                </div>
                ...
                <div id="counts" class="counts" style=" margin-top:80px;">
                    <div class="container">
                        <div class="count-boxes">
                            ...
                            <div class="count-box">
                                ...
                                <div class="right-content" style="margin-left:-1px">
                                    <p style="margin-left:0px;margin-right:10px;  color: #000; font-family: Manrope;">
                                        <b>Proses bimbingan hingga 2 bulan</b>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="count-box">
                                ...
                                <div class="right-content" style="margin-left:-1px">
                                    <p style="margin-left:0px;margin-right:10px; color: #000; font-family: Manrope;">
                                        <b>Jadwal bimbingan 3 kali dalam seminggu</b>
                                    </p>
                                </div>
                            </div>
                            <div class="count-separator" style="margin-top: 15px;"></div>
                            <div class="count-box">
                                ...
                                <div class="right-content" style="margin-left:-1px">
                                    <p style="margin-left:0px;margin-right:10px; color: #000; font-family: Manrope;">
                                        <b>Bimbingan sampai <br> 6 mata kuliah</b>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-center justify-content-between" style=" margin-top: -80px;">
                    <div class="row justify-content-center">
                        ...
                        <div style="margin-top:30px; margin-left:30px;">
                            ...
                            <div class="card">
                                <div style="display: flex; align-items: center; justify-content: center;">
                                    <img src="assets/img/bg/bmjcourse1.png" alt="">
                                </div>
                            ...
                            <div class="card">
                                <div style="display: flex; align-items: center; justify-content: center;">
                                    <img src="assets/img/bg/bmjschedule1.png" alt="">
                                </div>
                                <div style="width: 100%; height: 100%; color: black; font-size: 15px; font-family: Montserrat; font-weight: 550; line-height: 20px; word-wrap: break-word; padding: 10px;">
                            ...
                            <div class="card">
                                <div style="display: flex; align-items: center; justify-content: center;">
                                    <img src="assets/img/bg/bmjles1.png" alt="">
                                </div>
                                <div style="width: 100%; height: 100%; color: black; font-size: 15px; font-family: Montserrat; font-weight: 550; line-height: 20px; word-wrap: break-word; padding: 10px;">
                            ...
                            <div class="card">
                                <div style="display: flex; align-items: center; justify-content: center;">
                                    <img src="assets/img/bg/bmjgraduation1.png" alt="">
                                </div>
                                <div style="width: 100%; height: 100%; color: black; font-size: 15px; font-family: Montserrat; font-weight: 550; line-height: 20px; word-wrap: break-word; padding: 10px;">
                            ...
                            <div class="card">
                                <div style="display: flex; align-items: center; justify-content: center;">
                                    <img src="assets/img/bg/bmjkomunikasi1.png" alt="">
                                </div>
                                <div style="width: 100%; height: 100%; color: black; font-size: 15px; font-family: Montserrat; font-weight: 550; line-height: 20px; word-wrap: break-word; padding: 10px;">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row align-items-center justify-content-between" style="margin-top: -80px; position: relative;">
                    <div class="col-lg-6 text-center">
                        ...
                        <video width="260" height="460" controls style="margin-top: 50px; margin-left: 10px; border-radius: 28.99px; box-shadow: 0px 0px 15px rgba(0, 0, 255, 0.2);     border: 2px solid blue;" id="myVideo">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="section-title">
                            <span class="a">
                                <h3 style="margin-top: 50px; margin-left: -100px; text-align: left; font-size: 38px; color: #ffff; font-family: Montserrat;">
                                    Nanti di BMJ bakal <br> ngapain aja sih?</h3>
                            </span>
                            <div style="width: 100%; margin-left: -100px; height: 100%; position: relative">
                                <div style="width: 500px; margin-top:10px; left: 20px; margin-left: 40px; top: 0px; color: white; font-size: 16px; font-family: Montserrat; font-weight: 600;  text-align: left;">
                                    Sobat Insans akan mendapatkan pemahaman<br> mendalam terkait mata kuliah yang dipilih
                                </div>

                                <img style="width: 20px; height: 20px; left: 0px; top: 1px; position: absolute" src="assets/img/bg/ceklistbmj.png" />
                            </div>
                            <!-- 2 -->
                            <div style="width: 100%; margin-left: -100px; height: 100%; position: relative">
                ...
                <div class="juduldua">
                    <h3 style="letter-spacing: 1px !important;">
                        ...
                        <div style="width: 80%; height: 100%; display: flex; justify-content: center; margin-top: -52px; margin-left:120px;">
                            <div style="margin-left:-70px; width: 170px; height: 100%; padding: 6.40px; background: #3E87F8; box-shadow: 6.400178909301758px 6.400178909301758px 12.800357818603516px rgba(0, 0, 0, 0.15); border-radius: 32px; justify-content: center; align-items: center; gap: 6.40px; display: inline-flex;">
                                <div style="color: white; font-size: 20.48px; font-family: Montserrat; font-weight: 700; line-height: 25.60px; word-wrap: break-word">
                                    <a href="/login" style="color: #fff; letter-spacing: 0.1px; font-size:10px;">Pesan Sekarang</a>
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row" style="margin-bottom:120px; ">
                            <div class="col" style="margin-top:-50px;">
                                <div style="width: 100%; height: 100%; position: relative">
                                    <div style="width: 150px; height: 100px; padding: 27.25px; left: 0px; top: 29.40px; position: absolute; background: white; box-shadow: 0px 8.51637077331543px 42.58185577392578px rgba(0, 0, 0, 0.15); border-radius: 21.29px; border: 0.85px rgba(25, 24, 37, 0.10) solid; flex-direction: column; justify-content: flex-start; align-items: center; gap: 13.63px; display: inline-flex">
                                        <div style="letter-spacing: 0.1px; color: #3E87F8; font-size: 25px; font-family: Montserrat; font-weight: 700; line-height: 35.77px; word-wrap: break-word">
                                            20+</div>
                                        <div style="letter-spacing: 0.1px; color: #191825; font-size: 15px; font-family: Montserrat; font-weight: 600; line-height: 24.53px; word-wrap: break-word;    margin-top: -20px;">
                                            Jurusan</div>
                                    </div>
                                    <div style="width: 45px; height: 45px; padding: 16.96px; left: 132px; top: 10px; position: absolute; background: #3E87F8; box-shadow: 0px 0px 0px rgba(0, 0, 0, 0.03); border-radius: 52.99px">
                                    </div>
                                    <img style="width: 20px; height: 20px; left: 140px; top: 24px; position: absolute" src="assets/img/bg/bmjbook.png" />
                                </div>
                            </div>
                            ...
                            <div class="col" style="margin-top:-50px;">
                                <div style="width: 100%; height: 100%; position: relative">
                                    ...
                                    <div style="width: 45px; height: 45px; padding: 16.96px; left: 125px; top: 10px; position: absolute; background: #3E87F8; box-shadow: 0px 0px 0px rgba(0, 0, 0, 0.03); border-radius: 52.99px">
                                    </div>
                                    <img style="width: 18px; height: 22px; left: 133px; top: 24px; position: absolute" src="assets/img/bg/bmjuser.png" />
                                </div>
                            </div>
                        </div>
                    </h3>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row align-items-center justify-content-between" style=" margin-top: -80px;">
                    ...
                    <div class="section-title">
                        <!-- <h2>About</h2> -->
                        <span class="gariss">
                            <h3 style="color: black; margin-top: 100px; text-align: center; font-size: 35px; padding-bottom: 15px; font-family:Montserrat; ">
                    ...
                    <div class="container" data-aos="fade-up">
                        <div style=" width: 95%; height: 100%; margin-bottom:800px; position: relative; opacity: 0.85">
                            <img style="margin-left: 55px; width: 95%; height: 410px; position: absolute; mix-blend-mode: multiply; top: 0; left: 0;" src="assets/img/bg/bmjbg3.png" alt="">
                        </div>

                        <div id="cardbmj" class="cardbmj">
                            <div class="row align-items-center justify-content-between" style="margin-top: -800px; margin-bottom: 180px;  position: relative;">
                                ...
                                <div style="text-align: center; margin-top: 25px; margin-left: 400px; margin-right: auto;">
                                    ...
                                    <ul class="nav nav-pills card-header-pills" id="buttonGroup">
                                        <li class="nav-item" style="margin-left: -100px; margin-right: 80px;">
                                            <button class="nav-link color-white border-radius" onclick="TampilKonten('kontenbmj1')"><b style="font-family: Montserrat !important;">PAKET BRONZE</b></button>
                                        </li>
                                        <li class="nav-item" style="margin-right: 80px;">
                                            <button class="nav-link color-white2 border-radius" onclick="TampilKonten('kontenbmj2')" data-target="all"><b style="font-family: Montserrat !important;">PAKET
                                                    EMERALD</b></button>
                                        </li>
                                        <li class="nav-item" style="margin-right: -100px;">
                                            <button class="nav-link color-white2 border-radius" onclick="TampilKonten('kontenbmj3')" data-target="ktk"><b style="font-family: Montserrat !important;">PAKET
                                                    DIAMOND</b></button>
                                        </li>
                                    </ul>
                                ...
                                <div id="kontenbmj1" class="kontenbmj aktif">
                                    <img style="margin-bottom:50px; margin-top:-20px;  float: left; width: 280px;   margin-left: 120px;   height: auto;" src="assets/img/bg/bronze.png" alt="">
                                    <div style="font-family: Montserrat; text-align: left; margin-left: 450px; margin-top: 30px; color: white; font-size: 18px; font-weight: 400; line-height: 1.5; letter-spacing: -1px;">
                                    ...
                                    <div class="buttoncircle" style="display: flex; align-items: center;">
                                        <i class="bi bi-check2-circle" style=" margin-left: 50px; color: #fff; margin-top:-28px; margin-right: 10px; font-size:20px;"></i>
                                        <div style="font-family: Montserrat; text-align: left; margin-left: 10px; margin-top: 10px; color: white; font-size: 15px; font-weight: 400; line-height: 1.5; letter-spacing: -1px;">
                                ...
                                <div id="kontenbmj2" class="kontenbmj ">
                                    <img style="margin-bottom: 250px; margin-top:24px;   float: left; width: 280px;   margin-left: 120px;   height: auto;" src="assets/img/bg/paketemerald.png" alt="">
                                    <div style="font-family: Montserrat; text-align: left; margin-left: 450px; margin-top: 30px; color: white; font-size: 18px; font-weight: 400; line-height: 1.5; letter-spacing: -1px;">
                                ...
                                <div id="kontenbmj3" class="kontenbmj ">
                                    <img style="margin-bottom:50px; margin-top:24px;  float: left; width: 280px;   margin-left: 120px;   height: auto;" src="assets/img/bg/salwabmj-preview.png" alt="">
                                    <div style="font-family: Montserrat; text-align: left; margin-left: 450px; margin-top: 30px; color: white; font-size: 18px; font-weight: 400; line-height: 1.5; letter-spacing: -1px;">
        ...
        <section id="pricing" class="pricing" style="background-color:#09326f;  margin-bottom: 100px;">
            ...
            <div class="container" data-aos="fade-up">
                <div style="width: 100%; text-align: center;     margin-top: -30px;
                    ">
                    <div style="width: 100px; height: 30px; padding: 10px; background: #3E87F8; box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.15); border-radius: 50px; justify-content: center; align-items: center; gap: 10px; display: inline-flex; margin: 0 auto;">
                        <div style="width: 500px; text-align: center; color: white; font-size: 18px; font-family: Montserrat; font-weight: 700; line-height: 40px; word-wrap: break-word">
                            PAKET</div>
                    </div>
                </div>
                                    ...
                                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                                        <div class="custom-box" style="height: 380px; border-radius: 15px; width:280px;">
                                            ...
                                            <div class="rupiah-display" style="position: relative;">
                                                <h4 style="position: absolute; top: 0; left: 0; color: #1E1E1E; margin-right: 24px; font-size: 18px;">
                                                    <strong class="rp" style="margin-left: 30px; Montserrat !important;font-weight:bold;">Rp</strong>
                                                </h4>
                                                <h4 style="color: #1E1E1E;margin-left:60px; margin-bottom:-10px;font-family: Montserrat !important;font-weight:bold;">
                                                    400.000</h4>
                                            </div>
                                            <div class="custom-pricee" style="margin-right:14px; margin-top:10px;font-family: Montserrat !important;">
                                                <strong style="">1
                                                    Bulan</strong>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                                        <div class="custom-box" style="height: 380px; border-radius: 15px; width:280px;">
                                            ...
                                            <div class="rupiah-display" style="position: relative;">
                                                ...
                                                <h4 style="color: #1E1E1E;margin-left:60px; margin-bottom:-10px;Montserrat !important;font-weight:bold;">
                                                    565.000</h4>
                                            </div>
                                            <div class="custom-pricee" style="margin-right:14px; margin-top:-10px;Montserrat !important;">
                                                <strong>1
                                                    Bulan</strong>
                                            </div>
                                            <hr style=" border: 2px solid #000; border-width: 1px;">
                    ...
                    <div class="col-lg-6 text-centerr">
                        <div style="width: 100%; height: 100%; position: relative">
                            <div style="width: 50px; margin-left: 180px; left: 0px; top: -150px; position: absolute">
                                <div style="width: 75px; height: 75px; left: px; top: 0px; position: absolute; background: #09326F; border-radius: 9999px">
                                </div>
                                <div style="width: 65px; height: 65px; left: 7.66px; top: 0px; position: absolute; text-align: center; color: white; font-size: 105.11px; font-family: Montserrat; font-weight: 700; line-height: 131.38px; word-wrap: break-word">
                                    “</div>
                            </div>
        ...
        <section id="testimonials" class="testimonials" style="margin-top: -50px ;margin-bottom:px;">
        ...
        <section id="testimonials" class="testimonials" style=" margin-top: -50px; background: url(assets/img/bg/bgalur.png); background-size: cover; position: relative; text-align: center;">
            ...
            <img src="assets/img/bg/alurbimbingan.png" style="max-width: 35%;  height: auto; display: inline-block; margin-top: 50px;" class="img-fluid" alt="">
        </section>
                ...
                <div class="row align-items-center justify-content-between" style="margin-left: -140px; ">
                    <div class="col-lg-6 text-centerr">
                        <div style="width: 100%; height: 100%; position: relative; text-align:left;font-family: Montserrat !important;">
                            ...
                            <div style=" width: 500px; left: 50px; margin-top: 50px; top: -220px; position: absolute; color: white; font-size: 50px; font-family: Montserrat; font-weight: 700; line-height: 80.50px;">
                                Paling Sering </div>
                            <div style=" width: 500px; left: 50px; margin-top: 100px; top: -210px; position: absolute; color: white; font-size: 50px; font-family: Montserrat; font-weight: 700; line-height: 80.50px;">
                                Ditanyakan </div>
                        </div>
                    </div>
