   ...
   <div class="footer-top">
    <div class="container">
      <div class="row">
        ...
        <img src="assets/img/bg/footergaris.png" alt="Background Image" 
        class="garis1" 
        style=" stroke: #003EB5; 
        position: absolute;
               width: 2000px;
    ...
    <div class="row">           
      <!-- Background Image -->
        ...
        <div class="col-lg-4 col-md-3 footer-links" >
            <h4>Hubungi Kami</h4>
            <ul>
                <li><a href="Kelas-Tugas-Kuliah" style="color:white"><b>Alamat:</b> Jalan Bandara <br> <br> Palmerah IV No. D-11B,<br> <br> Cemorokandang,<br> <br> Kedungkandang, Kota Malang, <br> <br> Jawa Timur  <br> </a></li>  
                <li><a href="Kelas-Tugas-Kuliah" style="color:white"><b>Email:</b>classprogram.id@gmail.com <br></a></li> 
                  <li><a href="Kelas-Tugas-Kuliah" style="color:white"> <b>Whatsapp:</b> 0812-3436-1959 <br></a></li>  
                  <li><a href="Kelas-Tugas-Kuliah" style="color:white"> <b>Partnership:</b> <br> </a></li> 
                  <li><a href="Kelas-Tugas-Kuliah" style="color:white"> classprogram. id@gmailcom <br> <br> </a></li> 
        ...
        <div class="col-lg-4 col-md-3 footer-links">
            <h4>Program Kelas</h4>
            <ul>
              <li><a href="Kelas-Tugas-Kuliah" style="color:white">Kelas Tugas Kuliah (KTK) <br> <br> Bimbingan Mata Kuliah Jurusan <br> <br> (BMJ) <br> <br> Bimbingan Skripsi Online (BSO) <br> <br> Kelas Persiapan Karir (KPK) <br> <br> 
                Creative Class  <br> </a></li>  
                <li><a href="Kelas-Tugas-Kuliah" style="color:white"><b>Workshop:</b> <br></a></li> 
                <li><a href="Kelas-Tugas-Kuliah" style="color:white">Skripsi<br></a></li>
                <li><a href="Kelas-Tugas-Kuliah" style="color:white"> Karya Tulis Ilmiah (KTI) <br></a></li>  
                {{-- <li>
        ...
        <div class="col-lg-4 col-md-3 footer-links">
            ...
            <ul>
                <li><a href="skripsi" style="color:white">Masuk</a></li>
                <li><a href="kti" style="color:white">Daftar</a></li>
